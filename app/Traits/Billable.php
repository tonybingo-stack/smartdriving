...
use Carbon\Carbon;
use App\Entities\PaymentRequest;
...
trait Billable
{
    ...
    public function createPayment(
        #[ArrayShape(['description' => 'string', 'amount' => 'float', 'currency' => 'string', 'address' => '\App\Entities\Address', 'billingAddress' => '\App\Entities\Address', 'shippingAddress' => '\App\Entities\Address'])]
        array $options = []
    ): PaymentRequest {
