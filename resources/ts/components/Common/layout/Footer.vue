...
const logoPath = () => new URL(`/public/images/logo.jpg`, import.meta.url)
...
<template>
  ...
  ----------------------------------------------- -->
	<footer class="footer p-10 bg-primary text-base-content">
		<aside>
			<img :src="logoPath()" />
			<p><br /><span class="font-semibold">Made with ♥️ by Artificially </span><br /></p>
		</aside>
		<nav>
			<header class="footer-title text-white">Links</header>
			<Link
		...
		<nav>
			<header class="footer-title text-white">Legal</header>
